...
const userCreateValidation = () => {
  return [
    body("name")
      ...
      .isLength(3).withMessage("O nome precisa ter no mínimo 3 caracteres"),
    ...
    body("password")
      ...
      .isLength(5).withMessage("A senha precisa ter no mínimo 5 caracteres"),
...
const userUpdateValidation = () => {
  return [
    ...
    body("password")
      .optional()
      .isLength({min: 5}).withMessage("A senha precisa de pelo menos 5 caracteres."),
  ]
}
