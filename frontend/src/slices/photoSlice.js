...
export const updatePhoto = createAsyncThunk("photo/update", async (commentData, thunkApi) => {
...
export const getPhotos = createAsyncThunk("photo/allphotos", async (_, thunkApi) => {
